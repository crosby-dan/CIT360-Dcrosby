...
import static Main.TestController.Application_Controller_Pattern_CALCULATOR.goMath;
import Main.CollectionsThreads.CollectionsDemo;
import Main.CollectionsThreads.ThreadsDemo;
import Main.CollectionsThreads.AtomicityDemo;
        ...
        do {
            ...
            if (!matchResult)
                ...
                switch (Integer.parseInt(matcher.group(1))) {
                    ...
                    //case 3:  Main.AppController.ListRequestHandler process = new Main.AppController.ListRequestHandler(); break;
                    case 4:  goMath();
